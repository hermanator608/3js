...
export class CharacterControls {
     ...
     * @param {*} playerName 
     */
    constructor(model, mixer, animationsMap, orbitControl, camera, currentAction, playerName, body) {
        this.model = model
        this.mixer = mixer
    ...
    update(delta, keysPressed, playerName) {
    ...
    updatePlayerNamePos() {
        this.playerName.position.set(this.model.position.x, this.model.position.y + 0.5, this.model.position.z)
